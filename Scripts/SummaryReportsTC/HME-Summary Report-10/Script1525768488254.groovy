...
try{
	...
	//Get the Store ID for Second Store
	
	'Click on View/Edit link'
	CustomKeywords.'uiaction.CommonUIActions.click'(findTestObject('UsersPage/viewEditUsers1'))
	...
	String storeID1 =CustomKeywords.'uiaction.CommonUIActions.getText'(findTestObject('StorePage/storeID'))
	String storenumber1=storeID1.trim()
	println storenumber1
	...
	WebUI.click(findTestObject('ReportsPage/rawDataReportTimeOption'))

	WebUI.click(findTestObject('ReportsPage/summaryReportHeading'))

	'verify week is displayed in TimeSelection dropdown'

	WebUI.verifyElementText(findTestObject('ReportsPage/rawDataReportTimeOption'),CustomKeywords.'projectSpecific.Reusability.getTestData'("ReportsPage","rawDataReportTimeSelection"))

	'verify week is displayed in criteria week selection'
	WebUI.verifyElementText(findTestObject('ReportsPage/criteriaTimeMeasureForRawData'),CustomKeywords.'projectSpecific.Reusability.getTestData'("ReportsPage","criteriaRawDataTimeSelection"))

	//Step 3: To verify that user will not be able to generate weekly summary report for more than 1 Day - Step 1
	...
	String toDateValue =CustomKeywords.'projectSpecific.Reusability.getTestData'("ReportsPage","toDate7")
	...
	//Step 4: To verify that user will not be able to generate weekly summary report for more than 1 Day - Step 2
	...
	String errMsgText =CustomKeywords.'projectSpecific.Reusability.getTestData'("ReportsPage","DateErrorMsg3")
	WebUI.verifyMatch(errMessage, errMsgText, false)

	//Step 5: To select a single store

	'Uncheck the group'
	driver.findElement(By.xpath("//span[contains(text(),'"+groupmain+"')]/../../../../span[2]")).click()
	
	'Select only single store'
	driver.findElement(By.xpath("//span[contains(text(),'"+storenumber1.trim()+"')]")).click()

	//Step 6: To verify that user is able to generate weekly report for maximum of 1 Day
	...
	endDate=CustomKeywords.'projectSpecific.Reusability.getTestData'("ReportsPage","EndDate4")
	...
	toDateValue =CustomKeywords.'projectSpecific.Reusability.getTestData'("ReportsPage","fromDateJan")
	if(!dateAttr.equals(toDateValue))
	{
		if(TCflag)
			TCflag=false
	...
	String reportHeading =CustomKeywords.'projectSpecific.Reusability.getTestData'("SummarizedReportPage","rawCarDataReportHeading")
	WebUI.verifyElementText(findTestObject('SummarizedReportPage/rawCarDataHeading'),reportHeading)
