...
try{
	...
	//Step 3: To verify that user will not be able to generate weekly summary report for more than 1 months - Step 1
	WebUI.delay(GlobalVariable.MIN_DELAY)
	...
	String monthTextValue1=CustomKeywords.'projectSpecific.Reusability.getTestData'("ReportsPage","FebMonth")
	...
	//Step 4: To verify that user will not be able to generate weekly summary report for more than 1 month - Step 2
	...
	//Step 5: To verify that user is able to generate day report for maximum of 1 months
	WebUI.delay(GlobalVariable.MIN_DELAY)
	...
	monthTextValue1=CustomKeywords.'projectSpecific.Reusability.getTestData'("ReportsPage","FebMonth")
	...
	toDateValue =CustomKeywords.'projectSpecific.Reusability.getTestData'("ReportsPage","toDate4")
	if(!dateAttr.equals(toDateValue))
	{
		if(TCflag)
			TCflag=false
